package com.wncsl.core.infra.grpc;
...
public class GrpcClientService {
    ...
    public String createUser(final UserDTO userDTO) {
        try {
            UserGrpc request = build(userDTO);
    ...
    public void createCategoryStreamBidirectional(final List<UserDTO> userDTOlList){
        ...
        try {
            for (UserDTO userDTO : userDTOlList) {
                UserGrpc userGrpc = build(userDTO);
    ...
    public UserGrpc build(UserDTO dto){
